...
const faqData = [
  ...
  { q: 'Как отследить заказ?', a: 'После отправки заказа вы получите трек-номер на email. Отследить посылку можно в личном кабинете в разделе «Мои заказы».' },
  { q: 'Можно ли изменить или отменить заказ?', a: 'Вы можете изменить или отменить заказ до момента его отправки. Свяжитесь с нами по email или через форму обратной связи.' },
