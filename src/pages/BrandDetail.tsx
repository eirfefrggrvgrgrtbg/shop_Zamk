  ...
  return (
    <div className='relative z-10 min-h-screen pt-16 md:pt-20 pb-20'>
      <div className='container mx-auto px-4 sm:px-6 max-w-[1400px]'>
        ...
        <section className='mt-6 overflow-hidden rounded-[0.8rem] border border-white/45 bg-white/16 dark:border-white/10 dark:bg-white/5 backdrop-blur-sm'>
          <div className='relative h-[210px] md:h-[270px]'>
            ...
            <div className='relative z-10 h-full px-5 md:px-10 flex flex-col items-start justify-center gap-2 md:flex-row md:items-center md:justify-between md:gap-7'>
              <h2 className='font-serif text-[clamp(2.2rem,6.2vw,6.4rem)] text-white/43 dark:text-white/20 leading-[0.8] tracking-[-0.03em]'>{brand.country}</h2>
              <h3 className='font-serif text-[clamp(2.1rem,5.9vw,6.2rem)] text-white/42 dark:text-white/20 leading-[0.82] tracking-[-0.03em] text-center'>{brand.name}</h3>
