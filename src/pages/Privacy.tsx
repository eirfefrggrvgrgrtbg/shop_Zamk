      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-3xl py-8">
        ...
        <div className="bg-white rounded-3xl border border-border-lighter p-6 sm:p-8 space-y-6 text-sm text-ash leading-relaxed">
          <section>
            ...
            <p>Настоящая Политика конфиденциальности устанавливает порядок получения, хранения, обработки, использования и защиты персональных данных пользователей интернет-магазина ZAMK.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-graphite mb-3">2. Сбор информации</h2>
            <p>Мы собираем информацию, которую вы предоставляете при оформлении заказа: имя, email, телефон, адрес доставки. Мы также автоматически собираем данные о вашем устройстве и браузере для улучшения работы сайта.</p>
          </section>
