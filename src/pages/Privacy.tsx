        ...
        <section className="overflow-hidden rounded-[0.8rem] border border-white/45 bg-white/16 backdrop-blur-sm">
          <div className="relative h-[190px] md:h-[240px]">
            ...
            <div className="relative z-10 h-full px-5 md:px-10 flex flex-col items-start justify-center gap-2 md:flex-row md:items-center md:justify-between md:gap-7">
              <h2 className="font-serif text-[clamp(2rem,5.8vw,6rem)] text-white/43 leading-[0.8] tracking-[-0.03em]">ПОЛИТИКА</h2>
              <h3 className="font-serif text-[clamp(1.55rem,4.5vw,4.2rem)] text-white/42 leading-[0.82] tracking-[-0.03em] text-center">КОНФИДЕНЦИАЛЬНОСТИ</h3>
            </div>
          </div>
        </section>

        <div className="mt-8 bg-white/70 backdrop-blur-xl rounded-[2.5rem] border border-white p-8 md:p-12 space-y-8 text-base text-ash leading-relaxed shadow-cloud max-w-[980px] mx-auto">
          <section>
