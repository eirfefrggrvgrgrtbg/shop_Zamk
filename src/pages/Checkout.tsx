...
import { CheckoutPanel, HeroBlock, PillFilter, SectionHeader } from '../components/editorial/StudioKit';
      ...
      <div className='container mx-auto px-4 sm:px-6 max-w-[1280px]'>
        ...
        <div className='mt-6'>
          <HeroBlock
            ...
            title={<>Премиальный процесс оформления</>}
            description='Крупные rounded-секции: контактные данные, доставка, оплата и итог заказа в одной системе.'
          />
        </div>
