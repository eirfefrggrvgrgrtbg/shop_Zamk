...
import { login as apiLogin, register as apiRegister, refresh, me, logout as apiLogout, changePassword as apiChangePassword, forgotPassword as apiForgotPassword } from '@zamk/api-client/src/auth';
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const resetPassword = async (email: string) => {
    try {
      ...
      throw new Error(err.message || 'Ошибка отправки запроса');
    }
  };
