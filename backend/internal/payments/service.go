...
func NewService(repo *Repository, ordersRepo *orders.Repository, inventorySvc *inventory.Service, provider Provider, db *postgres.Client, notifSvc *notifications.Service) *Service {
	return &Service{
		repo:         repo,
