DROP TABLE IF EXISTS seller_ledger_entries CASCADE;
DROP TABLE IF EXISTS payout_batches CASCADE;
DROP TABLE IF EXISTS seller_commission_rules CASCADE;

-- Recreate old payouts
...
-- Recreate old seller_balance_ledger
