...
export const getAdminReturnReceivingQueue = async (): Promise<AdminReturnReceivingQueueItem[]> => {
  return request<AdminReturnReceivingQueueItem[]>('GET', '/admin/returns/receiving-queue');
};
...
export const getStaffMemberPermissions = async (userId: string): Promise<StaffMemberPermissionsResponse> =>
  request<StaffMemberPermissionsResponse>('GET', `/admin/staff/members/${userId}/permissions`);

export const updateStaffMemberPermissions = async (userId: string, data: UpdateStaffMemberPermissionsRequest): Promise<StaffMemberPermissionsResponse> =>
  request<StaffMemberPermissionsResponse>('PUT', `/admin/staff/members/${userId}/permissions`, { body: data });
...
export async function getStaffMember(userId: string): Promise<StaffMemberDetailResponse> {
  return request<StaffMemberDetailResponse>('GET', `/admin/staff/members/${userId}`);
}

export async function patchStaffMemberProfile(
  userId: string,
  req: UpdateStaffMemberProfileRequest
